...
: ${AMENT_CURRENT_PREFIX:="/root/workspaces/ros2_ws/install/library_world"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/library_world/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/library_world/environment/path.sh"
